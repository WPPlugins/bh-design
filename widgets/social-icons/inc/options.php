			...
			<tr>
				<td>Social Site
					<select name="social_media_names_list[]" id="" style="margin-top: 5px; width: 100%;">
						...
						<option <?php if(isset($social_icon_name[0]) && $social_icon_name[0] == "google" ) echo 'selected="selected"' ?> value="google">Google+</option>
					...
					<tr>
						<td>Social Site
							<select name="social_media_names_list[]" id="" style="margin-top: 5px; width: 100%;">
								...
								<option <?php if(isset($social_icon_name[$i]) && $social_icon_name[$i] == "google" ) echo 'selected="selected"' ?> value="google">Google+</option>
